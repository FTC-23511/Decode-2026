...
//    public static double TURRET_INTEGRATION_DECAY = 0.7;
    ...
    public static Vector2d TARGET_OFFSET = new Vector2d(0, 0);

    public static Pose2d GOAL_POSE() {
        return new Pose2d(-72 * ALLIANCE_COLOR.getMultiplier() + TARGET_OFFSET.getX(), 72 + TARGET_OFFSET.getY(), 0); // Inches
    }
