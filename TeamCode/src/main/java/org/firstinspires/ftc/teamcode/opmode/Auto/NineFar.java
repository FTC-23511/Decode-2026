...
@Config
@Autonomous(name = "NineFar", preselectTeleOp = "FullTeleOp", group = "Auto")
public class NineFar extends CommandOpMode {
    ...
    public void initialize() {
        ...
        schedule(
                new SequentialCommandGroup(
                        ...
                        new SequentialCommandGroup(
                                new SetIntake(Intake.MotorState.FORWARD),
                                new DriveTo(pathPoses.get(4), 0.6, 1.0).withTimeout(2000),
                                new DriveTo(pathPoses.get(5), 0.6, 1.0).withTimeout(100),
                                new DriveTo(pathPoses.get(6), 0.6, 1.0).withTimeout(1500)
                        ).interruptOn(() -> robot.intake.transferFull()),
