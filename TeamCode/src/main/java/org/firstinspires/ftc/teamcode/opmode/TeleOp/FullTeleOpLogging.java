...
//    private boolean endgame = false;
    ...
    private boolean initLogger() {
        ...
        try {
            ...
            logFileHandler = new FileHandler("/sdcard/FIRST/teleop_logger.log", false);
    ...
    public void run() {
        ...
        logger.info("Loop Time: " + timer.milliseconds());

        logger.info("Heading: " + robot.drive.getPose().getHeading());
        logger.info("Robot Pose: " + robot.drive.getPose());
        logger.info("Robot Target: " + robot.drive.follower.getTarget());
        logger.info("atTarget: " + robot.drive.follower.atTarget());

        logger.info("Turret State: " + Turret.turretState);
        logger.info("Turret Target: " + robot.turret.getTarget());
        logger.info("Turret Position: " + robot.turret.getPosition());
        logger.info("Turret readyToLaunch: " + robot.turret.readyToLaunch());
        logger.info("LLResult Null: " + (robot.turret.llResult == null));

        logger.info("Flywheel Active Control: " + robot.launcher.getActiveControl());
        logger.info("Flywheel Target Ball Velocity: " + robot.launcher.getTargetFlywheelVelocity());
        ...
        logger.info("Target Chassis Velocity: " + robot.drive.swerve.getTargetVelocity());
        logger.info("FR Module: " + robot.drive.swerve.getModules()[0].getTargetVelocity() + " | " + robot.drive.swerve.getModules()[0].getPowerTelemetry());
        logger.info("FL Module: " + robot.drive.swerve.getModules()[1].getTargetVelocity() + " | " + robot.drive.swerve.getModules()[1].getPowerTelemetry());
        logger.info("BL Module: " + robot.drive.swerve.getModules()[2].getTargetVelocity() + " | " + robot.drive.swerve.getModules()[2].getPowerTelemetry());
        logger.info("BR Module: " + robot.drive.swerve.getModules()[3].getTargetVelocity() + " | " + robot.drive.swerve.getModules()[3].getPowerTelemetry());
