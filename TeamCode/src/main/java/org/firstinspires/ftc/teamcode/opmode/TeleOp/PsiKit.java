...
public class PsiKit extends PsiKitOpMode{
         ...
         */
                ...
                Logger.recordOutput("Drive/Loop Time", timer.milliseconds());
                Logger.recordOutput("Drive/Heading", robot.drive.getPose().getHeading());
                Logger.recordOutput("Drive/RobotPose",robot.drive.getPose().toString());
                Logger.recordOutput("Drive/TargetChassisVelocity/Velocity",robot.drive.swerve.getTargetVelocity().toString());
                Logger.recordOutput("Drive/FRModule/Velocity",robot.drive.swerve.getModules()[0].getTargetVelocity().toString());
                Logger.recordOutput("Drive/FLModule/Velocity",robot.drive.swerve.getModules()[0].getTargetVelocity().toString());
                Logger.recordOutput("Drive/BRModule/Velocity",robot.drive.swerve.getModules()[0].getTargetVelocity().toString());
                Logger.recordOutput("Drive/FLModule/Velocity",robot.drive.swerve.getModules()[0].getTargetVelocity().toString());
            }
            Logger.end();
        }
