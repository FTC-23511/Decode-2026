...
/**
 * Implementation for curved paths where heading is holonomic (linearly interpolated).
 * Uses Quintic Hermite Splines for position and linear interpolation for heading.
 */
public class HolonomicSpline extends Spline {
    ...
    /**
     * Constructs a holonomic spline between two poses.
     * @param start start pose
     * @param end end pose
     */
    public HolonomicSpline(Pose2d start, Pose2d end) {
    ...
    /**
     * Constructs a holonomic spline between two poses with explicit tangent magnitudes.
     * @param start start pose
     * @param end end pose
     * @param startMag magnitude of the tangent vector at the start
     * @param endMag magnitude of the tangent vector at the end
     */
    public HolonomicSpline(Pose2d start, Pose2d end, double startMag, double endMag) {
    ...
    public double getTargetHeading(double t) {
        ...
        return MathUtils.normalizeRadians(h0 + t * diff, false);
    }
}
