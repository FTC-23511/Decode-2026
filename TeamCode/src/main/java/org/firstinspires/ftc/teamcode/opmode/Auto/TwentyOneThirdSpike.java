...
@Config
@Autonomous(name = "TwentyOneThirdSpike", preselectTeleOp = "FullTeleOp", group = "Auto")
public class TwentyOneThirdSpike extends CommandOpMode {
    ...
    public void generatePath() {
        ...
        pathPoses.add(new Pose2d(-62.92436974789916, -15.529411764705873, Math.toRadians(0))); // Line 3
        pathPoses.add(new Pose2d(-11.89915966386554, 0, Math.toRadians(0))); // Line 4
        pathPoses.add(new Pose2d(-60.80025210084033, -18.012605042016805, Math.toRadians(-30))); // Line 5
        pathPoses.add(new Pose2d(-59.80025210084033, -10.15126050420168, Math.toRadians(-30))); // Line 6
        pathPoses.add(new Pose2d(-13.109243697478991, 2.823529411764703, Math.toRadians(0))); // Line 7
        pathPoses.add(new Pose2d(-57.68067226890756, 13.714285714285712, Math.toRadians(0))); // Line 8
        pathPoses.add(new Pose2d(-11.092436974789912, 9.075630252100837, Math.toRadians(0))); // Line 9
        pathPoses.add(new Pose2d(-30.25210084033613, -35.09243697478992, Math.toRadians(0))); // Line 10
        pathPoses.add(new Pose2d(-63.529411764705884, -35.09243697478992, Math.toRadians(0))); // Line 11
        pathPoses.add(new Pose2d(-15.73109243697479, 8.067226890756302, Math.toRadians(0))); // Line 12
        pathPoses.add(new Pose2d(-43.563025210084035, 5.445378151260499, Math.toRadians(0))); // Line 13
    ...
    public void initialize() {
        ...
        schedule(
                new SequentialCommandGroup(
                        ...
                        // intake 3rd spike
                        new DriveTo(pathPoses.get(10), 1).withTimeout(400),
                        pathIntake(11, 1550),
                        new WaitCommand(500),
